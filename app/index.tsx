...
//   const Header = (
//     <View style={{ alignSelf: "center", maxWidth: 1100, width: "100%" }}>
//       {/* Hero Section */}
//       <ImageBackground
//         source={getHeroSource(HERO)}
//         style={homeStyles.heroFull}
//         imageStyle={homeStyles.heroImage}
//         resizeMode="cover"
//       >
...
//         <Text style={homeStyles.sectionTitle}>Crafted with Care</Text>
//         <Text style={homeStyles.sectionLead}>
//           Our candles are meticulously crafted using premium natural waxes and essential oils.
//         </Text>
//       </View>
//     </View>
//   );
...
//         renderItem={({ item }) => (
//           <Link href={`/product/${item.id}`} asChild>
//             <Pressable style={[homeStyles.card, isNarrow && { width: "100%" }]}>
//               <Image
//                 source={
//                   item.image_urls?.[0]?.url
//                     ? { uri: item.image_urls[0].url }
