...
// // Synchronous guest id for headers (critical for RLS)
// const guestId = getGuestIdSync();

// // Create client with a GLOBAL header your RLS can read
...
// // On RN, reconcile AsyncStorage in background (no await needed)
