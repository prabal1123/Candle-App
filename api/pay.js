...
//     const key_id = process.env.RAZORPAY_KEY_ID;
//     const base = (process.env.PUBLIC_BASE_URL || "").replace(/\/$/, "") || getOrigin(req);
//     if (!key_id || !base) return res.status(500).send("Server not configured");
...
//   <title>Redirecting to payment…</title>
//   <style>body{font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;padding:24px}.card{max-width:520px;margin:24px auto;padding:20px;border:1px solid #eee;border-radius:12px}.btn{display:inline-block;padding:12px 16px;border-radius:8px;border:1px solid #ddd;text-decoration:none}</style>
//   <script src="https://checkout.razorpay.com/v1/checkout.js"></script>
// </head>
// <body>
//   <div class="card">
